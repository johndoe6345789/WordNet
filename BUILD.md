...
## Linting (clang-tidy and cppcheck)

Install the tools with your system package manager:
...
Then run the targets generated by CMake:

```bash
# Conan build directory
cmake --build build/build/Release --target lint
